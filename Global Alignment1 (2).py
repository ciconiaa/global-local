...
q_s = 'input sequence s\n'
q_t = 'input sequence t\n'
termination = 'Exit'
printError = 'Error'
comment1 = 'p(i,j) matrix for the allignment'
comment2 = 'a(i,j) matrix for the score of the prefixes of the allignment'
g = -2
plus = 1
a1 = input(q1)
if a1 == 'g':
                ...
                if a[n_t-i][n_s-j] == a[n_t-i-1][n_s-j-1]+p[n_t-i-1][n_s-j-1]:
                    ...
                    if a[n_t-i][n_s-j] == a[n_t-i-1][n_s-j]+g:
                        ...
                        if a[n_t-i][n_s-j] == a[n_t-i][n_s-j-1] + g:
                            ...
                            align_count = align_count+1
        #print(align_i, '\n', align_j)
# Правільне розташування шляху вирівнювання
        res_t = ''
        res_s = ''
        for i in range(maxNumber):
